##############################################
# OpenWrt Makefile for Laydrop WifiBox firmware
##############################################
...
define Package/wifibox
	...
	MENU:=1
#	DEFAULT:=y
	TITLE:=Laydrop WifiBox firmware
	URL:=http://www.laydrop.com/wifibox
	DEPENDS:=+lua +luafilesystem +libuci-lua +libiwinfo-lua +uhttpd +uhttpd-mod-lua +laydrop-client +print3d
endef

define Package/wifibox/description
	Laydrop WifiBox firmware
